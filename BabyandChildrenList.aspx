<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="BabyandChildrenList.aspx.cs" Inherits="BabyandChildrenList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <span class="style2"><strong style="color: #000080; font-family: 'Segoe UI'">
    Category: </strong></span>&nbsp;&nbsp;&nbsp;
    <asp:Label ID="BabyandChildrenLabel" runat="server" 
        style="font-size: medium; font-weight: 700; color: #000080; font-family: 'Segoe UI'" 
        Text="Baby and Children"></asp:Label>
    <br />
    <br />
