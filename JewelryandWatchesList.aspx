<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="JewelryandWatchesList.aspx.cs" Inherits="JewelryandWatchesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:Label ID="JewelryandWatchesLabel" runat="server" 
            style="font-size: medium; font-weight: 700" Text="Jewelry and Watches"></asp:Label>
    </p>
    <p>
