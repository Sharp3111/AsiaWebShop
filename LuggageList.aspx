<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="LuggageList.aspx.cs" Inherits="LuggageList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:Label ID="LuggageLabel" runat="server" 
            style="font-size: medium; font-weight: 700" Text="Luggage"></asp:Label>
    </p>
    <p>
