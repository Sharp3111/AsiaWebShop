<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="ToysandGamesList.aspx.cs" Inherits="ToysandGamesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:Label ID="ToysandGamesLabel" runat="server" 
            style="font-size: medium; font-weight: 700" Text="Toys and Games"></asp:Label>
    </p>
    <p>
