<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="WomenList.aspx.cs" Inherits="WomenList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:Label ID="WomenLabel" runat="server" 
            style="font-size: medium; font-weight: 700" Text="Women"></asp:Label>
    </p>
    <p>
