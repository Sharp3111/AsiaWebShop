<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="AppliancesList.aspx.cs" Inherits="AppliancesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:Label ID="AppliancesLabel" runat="server" 
            style="font-size: medium; font-weight: 700" Text="Appliances"></asp:Label>
    </p>
    <p>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Button ID="Button1" runat="server" CausesValidation="false" 
                        CommandName="Select" PostBackUrl="~/MemberOnly/ShoppingCart.aspx" 
