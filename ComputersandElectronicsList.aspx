<%@ Page Title="" Language="C#" MasterPageFile="~/AsiaWebShopSite.master" AutoEventWireup="true" CodeFile="ComputersandElectronicsList.aspx.cs" Inherits="ComputersandElectronicsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:Label ID="ComputersandElectronicsLabel" runat="server" 
            style="font-size: medium; font-weight: 700" Text="Computers and Electronics"></asp:Label>
    </p>
    <p>
