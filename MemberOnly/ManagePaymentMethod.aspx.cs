...
public partial class MemberOnly_PaymentMethodManagement : System.Web.UI.Page
{
    ...
    protected void dvCreditCard_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
    {
        Page.Validate();
    ...
    protected void dvCreditCard_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        ...
        //    {
        //        //if the edited credit card changes from default to non default, error message.
        //        if (((CheckBox)(dvCreditCard.FindControl("InsertCreditCardDefault"))).Checked == false)
        //        {
        //            ((CheckBox)(dvCreditCard.FindControl("InsertCreditCardDefault"))).Checked = true;
        //            ((CheckBox)(dvCreditCard.FindControl("InsertCreditCardDefault"))).Enabled = false;
        //            lblMessage.ForeColor = System.Drawing.Color.Red;
        //            lblMessage.Text = "This is your only credit card in your credit card list. You have to have this credit card as the default credit card.";
        //        }
        //    }
        ...
        //    {
        //        //if the edited credit card changes from nondefault to default, then the initial default card becomes nondefault
        //        if (((CheckBox)(dvCreditCard.FindControl("InsertCreditCardDefault"))).Checked == true)
        //        {
        //            //find the initial default number for later update
        //            string currentCardNumber = ((TextBox)dvCreditCard.FindControl("InsertCardNumber")).Text.Trim();
        //            string initialDefaultNumber = "";
